...
(function(){
  ...
  const detailArt = {
    ...
    'beast-tribe': { image:'https://imgur.com/HAUcIBg.png', alt:'', position:'right center', scale:1 },
    'birdfolk': { image:'https://imgur.com/vSJI2qM.png', alt:'', position:'right center', scale:1 },
    ...
    'feralus': { image:'', alt:'', position:'right center', scale:1 },
    'firbolg': { image:'', alt:'', position:'right center', scale:1 },
    'flooflin': { image:'', alt:'', position:'right center', scale:1 },
    'framebilt': { image:'', alt:'', position:'right center', scale:1 },
    'gnome': { image:'', alt:'', position:'right center', scale:1 },
    'goblin': { image:'', alt:'', position:'right center', scale:1 },
    'goliath': { image:'', alt:'', position:'right center', scale:1 },
    'hadislin': { image:'', alt:'', position:'right center', scale:1 },
    'halfling': { image:'', alt:'', position:'right center', scale:1 },
    'hanyou': { image:'', alt:'', position:'right center', scale:1 },
    'hobgoblin': { image:'', alt:'', position:'right center', scale:1 },
    'human': { image:'', alt:'', position:'right center', scale:1 },
    'ilthrak-yar': { image:'', alt:'', position:'right center', scale:1 },
    'kaijou': { image:'', alt:'', position:'right center', scale:1 },
    'kits-adria': { image:'', alt:'', position:'right center', scale:1 },
    'kobold': { image:'', alt:'', position:'right center', scale:1 },
    'kua-hono': { image:'', alt:'', position:'right center', scale:1 },
    'merfolk': { image:'', alt:'', position:'right center', scale:1 },
    'minotaur': { image:'', alt:'', position:'right center', scale:1 },
    'nephilim': { image:'', alt:'', position:'right center', scale:1 },
    'orc': { image:'', alt:'', position:'right center', scale:1 },
    'petratara': { image:'', alt:'', position:'right center', scale:1 },
    'primordia': { image:'', alt:'', position:'right center', scale:1 },
    'tarnished': { image:'', alt:'', position:'right center', scale:1 },
    'trealtin': { image:'', alt:'', position:'right center', scale:1 },
    'vanquis': { image:'', alt:'', position:'right center', scale:1 },
    'animus': { image:'', alt:'', position:'right center', scale:1 },
    'drackal': { image:'', alt:'', position:'right center', scale:1 },
    'noxiamorph': { image:'', alt:'', position:'right center', scale:1 },
    'changeling': { image:'', alt:'', position:'right center', scale:1 },
