...
check(manifest.version === '5.58.0' && packageJson.version === '5.58.0' && packageLock.version === '5.58.0' && read('js/config.js').includes("APP_VERSION='5.58.0'"), 'versão 5.58.0 sincronizada');
...
if (errors.length) {
  ...
  console.error(`Admin 5.58.0 reprovado: ${errors.length} erro(s).`);
  process.exit(1);
}
console.log(`Admin 5.58.0 aprovado: ${passed.length} verificações, 0 erros, 0 avisos.`);
