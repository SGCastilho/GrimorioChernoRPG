...
const versionParts=String(manifest.version||'').split('.').map(Number);const post5304=versionParts[0]>5||(versionParts[0]===5&&(versionParts[1]>30||(versionParts[1]===30&&versionParts[2]>=4)));if(!post5304||manifest.races!==34||manifest.raceSubraces!==196||manifest.raceTraitRecords!==928||manifest.racesTextReviewed!==34)fail('Manifest pós-5.30.4 inconsistente.');else ok('Manifest pós-5.30.4 sincronizado');
