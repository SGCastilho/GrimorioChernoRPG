...
const report={
  ...
  samples:[
    'classe-barbaro-individual.json','subclasse-caminho-do-kaiju-individual.json','classe-cavaleiro-draconico-individual.json','subclasse-tecelao-de-sangue-individual.json','pacote-barbaro-classe-completa.json'
  ],
