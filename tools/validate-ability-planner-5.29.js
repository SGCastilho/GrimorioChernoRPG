...
if(!app.includes("navigate(\\'ability-planner\\')")&&!app.includes("navigate('ability-planner')")&&!app.includes("routeHref('ability-planner'")&&!app.includes("item('ability-planner'"))fail('Menu não possui rota ability-planner.');else ok('Rota presente na navegação');
if(!ui.includes("navigate(\\'ability-planner\\')")&&!ui.includes("navigate('ability-planner')")&&!ui.includes("routeHref('ability-planner'")&&!ui.includes("navA('ability-planner'"))fail('Navegação aprimorada não possui atalho para ability-planner.');else ok('Atalho presente na navegação aprimorada');
