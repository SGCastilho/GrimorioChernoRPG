...
ok(manifest.version==='5.69.1','versão 5.69.1 registrada no manifesto');
...
if(errors.length){errors.forEach(e=>console.error('✗ '+e));console.error(`Maestrias Avançadas 5.69.1 reprovadas: ${errors.length} erro(s).`);process.exit(1);}
passed.forEach(e=>console.log('✓ '+e));
console.log(`Maestrias Avançadas 5.69.1 aprovadas: ${passed.length} verificações, 0 erros.`);
