...
if(manifest.version!=='5.70.0'||manifest.subclasses!==400||manifest.paraprismaticTempestSubclasses!==18||manifest.paraprismaticTempestSubclassFeatures!==95||manifest.paraprismaticTempestSubclassReferences!==4||manifest.paraprismaticTempestSubclassTables!==8||manifest.registeredSources!==19)fail('manifest.json não está sincronizado com 5.70.0.'); else ok('Manifest 5.70.0 sincronizado');
