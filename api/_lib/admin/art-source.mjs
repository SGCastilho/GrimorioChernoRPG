...
function propertyName(property) {
  if (property.type !== 'Property' || property.computed || property.kind !== 'init' || property.method || property.shorthand) fail(500, 'INVALID_ART_SOURCE', 'O mapa de artes contém uma propriedade não suportada.');
